...
CREATE TABLE IF NOT EXISTS `hvz_games` (
  ...
  `zombie_starve_time` smallint(6) NOT NULL default '48' COMMENT 'Hours',
  `zombie_stun_time` smallint(6) NOT NULL default '15' COMMENT 'Minutes',
  `zombie_feed_time` smallint(6) NOT NULL default '48' COMMENT 'Hours',
  PRIMARY KEY  (`id`)
